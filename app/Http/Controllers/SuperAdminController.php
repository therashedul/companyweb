...
// ========================================== Gallery
    ...
    {
        return (new Settingcrud)->videoindex();
    }
    public function videocreate()
    {
        return (new Settingcrud)->videocreate();
    }
    public function videostore(Request $request)
    {
        return (new Settingcrud)->videostore($request);
    }
    public function videoedit($id)
    {
        return (new Settingcrud)->videoedit($id);
    }
    public function videopublish($id)
    {
        return (new Settingcrud)->videopublish($id);
    }
    public function videounpublish($id)
    {
        return (new Settingcrud)->videounpublish($id);
    }
    public function videoupdate(Request $request, $id)
    {
        return (new Settingcrud)->videoupdate($request, $id);
    }
    public function videodelete($id)
    {
        return (new Settingcrud)->videodelete($id);
    }
     public function videoupload(Request $request)
    {
        return (new Settingcrud)->videoupload($request);
    }
    // ================================
    // ===================== Language change
