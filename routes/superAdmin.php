   ...
   // whitelist
    ...
    // page
       ...
       Route::get('/slider', [App\Http\Controllers\SuperAdminController::class, 'sliderindex'])->name('slider');
        ...
        //Gallery part
        // ===========================================
       Route::get('/gallery', [App\Http\Controllers\SuperAdminController::class, 'galleryindex'])->name('gallery');
        Route::get('gallery.create', [App\Http\Controllers\SuperAdminController::class, 'gallerycreate'])->name('gallery.create');
        Route::post('gallery.store', [App\Http\Controllers\SuperAdminController::class, 'gallerystore'])->name('gallery.store');
        Route::get('gallery.edit/{id}', [App\Http\Controllers\SuperAdminController::class, 'galleryedit'])->name('gallery.edit');                
        Route::post('gallery.update.{id}', [App\Http\Controllers\SuperAdminController::class, 'galleryupdate'])->name('gallery.update');
          Route::post('/slider.upload', [App\Http\Controllers\SuperAdminController::class, 'sliderupload'])->name('slider.upload');  
        Route::get('gallery.deleted.{id}', [App\Http\Controllers\SuperAdminController::class, 'gallerydelete'])->name('gallery.deleted');

         Route::get('gallery.popup/{id}', [App\Http\Controllers\SuperAdminController::class, 'gallerypopup'])->name('gallery.popup');
        Route::get('gallery.unpopup/{id}', [App\Http\Controllers\SuperAdminController::class, 'galleryunpopup'])->name('gallery.unpopup');      
        
        Route::get('gallery.partnar/{id}', [App\Http\Controllers\SuperAdminController::class, 'gallerypartnar'])->name('gallery.partnar');
        Route::get('gallery.unpartnar/{id}', [App\Http\Controllers\SuperAdminController::class, 'galleryunpartnar'])->name('gallery.unpartnar');
        
        Route::get('gallery.publish/{id}', [App\Http\Controllers\SuperAdminController::class, 'gallerypublish'])->name('gallery.publish');
        Route::get('gallery.unpublish/{id}', [App\Http\Controllers\SuperAdminController::class, 'galleryunpublish'])->name('gallery.unpublish');        

        

        //Video part
        // ===========================================
       Route::get('/video', [App\Http\Controllers\SuperAdminController::class, 'videoindex'])->name('video');
        Route::get('video.create', [App\Http\Controllers\SuperAdminController::class, 'videocreate'])->name('video.create');
        Route::post('video.store', [App\Http\Controllers\SuperAdminController::class, 'videostore'])->name('video.store');
        Route::get('video.edit/{id}', [App\Http\Controllers\SuperAdminController::class, 'videoedit'])->name('video.edit');                
        Route::post('video.update.{id}', [App\Http\Controllers\SuperAdminController::class, 'videoupdate'])->name('video.update');
          Route::post('/slider.upload', [App\Http\Controllers\SuperAdminController::class, 'sliderupload'])->name('slider.upload');  
        Route::get('video.deleted.{id}', [App\Http\Controllers\SuperAdminController::class, 'videodelete'])->name('video.deleted');
         Route::get('video.publish/{id}', [App\Http\Controllers\SuperAdminController::class, 'videopublish'])->name('video.publish');
        Route::get('video.unpublish/{id}', [App\Http\Controllers\SuperAdminController::class, 'videounpublish'])->name('video.unpublish');
